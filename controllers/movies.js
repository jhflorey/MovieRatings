...
module.exports = function (router) {
    ...
    // Search release date
    router.post('/search/release_date', function(req, res){
        Movie.search(req.body.searchDate, {month: 1, day: 1, year: 1},{
          conditions: {month:{$exists: true}, date: {$exists: true}, year:{$exists: true}},
          sort: {release_date: 1},
          limit: 10
        }, function(err, movies){
          if(err){
